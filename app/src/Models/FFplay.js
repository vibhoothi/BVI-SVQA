...
class FFmpegBM {
  ...
  load(file) {
    ...
    var grayCmd = this.#playerPath + " -f lavfi -i color=gray:4096x2160:d=5,format=rgb24 -f decklink -pix_fmt uyvy422 -r " + param_vals[0] + " -s " + param_vals[1] + " -an 'DeckLink 8K Pro (1)'  -loglevel quiet ";
    execSync(grayCmd);
